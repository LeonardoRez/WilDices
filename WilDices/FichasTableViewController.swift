//
//  FichasTableViewController.swift
//  WilDices
//
...
class FichasTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "fichaIdentifier", for: indexPath)

        // Configure the cell...
        
        if let fichaCell = cell as? FichaTableViewCell{
            let personagem = personagens[indexPath.row]
            
            fichaCell.nomePersonagemLabel.text = personagem.nomePersonagem
            fichaCell.nomeJogadorLabel.text  = personagem.jogador.nomeJogador
